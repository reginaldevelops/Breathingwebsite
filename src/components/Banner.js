...
import tiktokLogo from "../img/tiktoklogo2.png";
import tiktokmonogram from "../img/tiktokmonogram.png";
import { motion } from "framer-motion";
import { float, fadeUp } from "../animation";
...
const BannerSection = () => {
  return (
    <Banner aria-label="TikTok badge">
      <Accent />
      <Badge
        as={motion.a} // makes the styled-component motion-enabled
        variants={fadeUp} // or fadeUp, slideRight, etc.
        initial="hidden"
        animate="show" // for looping animations like float
        // whileInView="show" initial="hidden" if you use fadeUp instead
...
const Banner = styled.div`
  display: block;
  background: url(${tiktokmonogram}) repeat 0px 340px;
